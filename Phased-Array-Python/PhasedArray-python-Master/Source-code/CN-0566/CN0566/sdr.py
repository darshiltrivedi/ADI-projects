...
class sdr(ad9361):
    ...
    """ This method configures sdr with respect to current frequency plan."""
    def configure(self):
        ...
        self.sample_rate = int(3000000)  # Sampling rate
