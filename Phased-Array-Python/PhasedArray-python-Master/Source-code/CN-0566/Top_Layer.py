...
"""This can be useful in Array size vs beam width experiment or beamtappering experiment. Set the gain of outer channels
    to 0 and beam width will increase and so on."""
my_beamformer.set_chan_gain(3, 120)  # set gain of Individual channel
my_beamformer.set_all_gain()  # Set all gain to calibrated values, if not cal, 127 i.e. max gain
...
my_beamformer.plot(plot_type="monopulse")
...
my_beamformer.gain_calibration()
my_beamformer.phase_calibration()
