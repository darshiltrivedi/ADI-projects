...
num_adars = 2  # number of adar1000 connected and switch to toggle between Pluto and ad9361. Pluto == 1(1r1t) and ad9361 == 2(2r2t)
tx_source = "adf4159"
rpi_ip = "ip:10.84.10.64"  # IP address of the Raspberry Pi
