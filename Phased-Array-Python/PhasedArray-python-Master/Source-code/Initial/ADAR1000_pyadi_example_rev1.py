...
if DEVICE_MODE == "rx":
    ...
    if SELF_BIASED_LNAs:
        ...
        beam0.lna_bias_out_enable = False    # this writes 0xA0 0x30 0x00.  What does this do?
        #beam0._ctrl.reg_write(0x30, 0x00)   #Disables PA and DAC bias
    else:
        # Set the external LNA bias
        beam0.lna_bias_on = -0.7       # this writes 0x25 to register 0x2D.  This is correct.  But oddly enough, it doesn't first write 0x18 to reg 0x00....
        #beam0._ctrl.reg_write(0x30, 0x20)   #Enables PA and DAC bias.  I think this would be needed too?
